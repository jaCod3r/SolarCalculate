...
var panelNeeded = realWattNeeds /  panelOutput;
//console.log(Math.ceil(panelNeeded));

var feedback = "";
    feedback += "<p>Based on your average daily use of "+ Math.round(dailyUseKw) +" kwh, you will need to purchase "+ Math.round(panelNeeded) +" "+panelName+" solar panels to offset 100% of your electricity bill. </p>";
    feedback += "<h2> Additional Details </h2>";
    feedback += "<p>Your average daily electricity consumption: "+Math.round(dailyUseKw)+" Kwh per day.</p>";
    feedback += "<p>Average sunshine per hour "+sunHoursPerDay+" watts/hour. </p>";
    feedback += "<p>Realistic watts needed per hour: "+Math.round(realWattNeeds)+"";
